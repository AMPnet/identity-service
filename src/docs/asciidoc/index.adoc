...
=== Get Auto-invest Task Amount
Returns pending auto-invest value for the specified campaign for the current user. If the uses has not requested
auto-invest for the campaign, zero will be returned for the amount.
